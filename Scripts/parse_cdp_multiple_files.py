    ...
    with open(file_name, "r") as f:
        ...
        *** ACTION: Adjust based on hostname structure. ***
        ...
        for item in output[cdp_start:cdp_end]:
            if "cisco.com" in item:
                neighbors.append(item.split()[0].strip("cisco.com"))
